...
``background-position`` を指定して、ピースごとに元画像の別々の場所が表示されるようにします。
...
16枚のピースを納める枠を追加します。枠のサイズを720px×720pxにすることで、ピースが4枚ごとに横に並びます。
...
ここまでで15パズルっぽい見た目になってきたと思います。しかしまだピースを動かせないので全然遊べませんね。
